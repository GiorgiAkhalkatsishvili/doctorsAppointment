...
import './PediatricianDoc.css'
import { Link } from 'react-router-dom';

const PediatricianDoc = () => {
  const [options, setOptions] = useState(false);
  const doctors = useSelector((state) => state.doctors.doctors);
  const firstDoctor = doctors[3];
  const seventhDoctor = doctors[8];
...
export default PediatricianDoc;
