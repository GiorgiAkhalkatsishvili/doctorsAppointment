...
const SecondDocotorPage = () => {
 ...
 const handleBookAppointment = () => {
     ...
     {' '}<p>Appointment booked successfully!</p>
       ...
       dispatch(selectDoctor(TenthDoctor));
   }
     setTimeout(() => {
    setMessage('')
    setError('')
...
treatment strategies.</p>
          ...
          <div className="doctor-fee">
            <h4>Appointment fee: <span>{TenthDoctor.fee}</span> </h4>
            </div>
         </div>
  ...
  {TenthDoctor.dates.map((day, index) => (
    <div 
      key={index}
  ...
  <div className="booking-time">
        {TenthDoctor.time.map((time, index) => (
      <div>
