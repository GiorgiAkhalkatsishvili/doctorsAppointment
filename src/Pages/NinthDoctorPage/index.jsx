...
const SecondDocotorPage = () => {
 ...
 const handleBookAppointment = () => {
    ...
    {' '}<p>Appointment booked successfully!</p>
      ...
      dispatch(selectDoctor(NinthDoctor));
  }
    setTimeout(() => {
   setMessage('')
   setError('')
...
treatment strategies.</p>
          ...
          <div className="doctor-fee">
            <h4>Appointment fee: <span>{NinthDoctor.fee}</span> </h4>
            </div>
         </div>
  ...
  {NinthDoctor.dates.map((day, index) => (
    <div 
      key={index}
   ...
   <div className="booking-time">
        {NinthDoctor.time.map((time, index) => (
      <div>
