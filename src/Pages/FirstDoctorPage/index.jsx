...
import '../../Pages/FirstDoctorPage';
import './FirstDoctorPage.css'
...
const FirstDoctorPage = () => {
  ...
  <FontAwesomeIcon icon={faCircleCheck} style={{ color: 'green', fontSize: '25px' }} />
    {' '}<p>Appointment booked successfully!</p>
      ...
      dispatch(selectDoctor(firstDoctor));
 }
    setTimeout(() => {
      setMessage('')
      setError('')
...
treatment strategies.</p>
          ...
          <div className="doctor-fee">
            <h4>Appointment fee: <span>{firstDoctor.fee}</span> </h4>
            </div>
         </div>
  ...
  {firstDoctor.dates.map((day, index) => (
    <div 
      key={index}
